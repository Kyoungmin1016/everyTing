...
public class BoardController {
	...
	public String createBoardGet() throws Exception{
	...
	public String presentBoardContent(@RequestParam("num")int num,Model model) throws Exception{
	...
	public String applyBoard(@RequestParam("num")int num,HttpServletRequest request,RedirectAttributes rttr) throws Exception{
	...
	public String checkApplyBorad(HttpServletRequest request,Model model) throws Exception{
